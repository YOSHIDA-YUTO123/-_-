...
// コンストラクタ
//===================================================
CObject2DMT::CObject2DMT() : CObject(PRIORITY::PRIORITY_UI_FRONT)
{
...
CObject2DMT* CObject2DMT::Create(const D3DXVECTOR3 pos, const D3DXVECTOR2 Size)
{
	...
	pObject->SetRotaition(Const::VEC3_NULL);
...
void CObject2DMT::Draw(void)
{
	...
	{
		// テクスチャを設定
		pDevice->SetTexture(nCnt, pTextureManager->GetAdress(m_nTextureIdx[nCnt]));
	}
...
void CObject2DMT::SetTextureID(const char* pTexture1, const char* pTexture2)
{
	...
	m_nTextureIdx[0] = pTextureManager->Register(filePath.c_str());
	...
	// IDの設定
	m_nTextureIdx[1] = pTextureManager->Register(filePath.c_str());
}
