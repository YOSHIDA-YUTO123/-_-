...
// 静的メンバ変数の宣言
//***************************************************
CObject* CObject::m_pTop[CObject::PRIORITY_MAX] = { nullptr }; // 先頭オブジェクトへのポインタ
CObject* CObject::m_pCur[CObject::PRIORITY_MAX] = { nullptr }; // 最後尾オブジェクトへのポインタ
int CObject::m_nNumAll[CObject::PRIORITY_MAX] = { NULL };	  // オブジェクトの総数
